...
rna = readRDS(file = 'data/dataset.islet.rnaseq.rds')
```

::::::::::::::::::::::::::::::::::::: challenge 

## Challenge 1: What is the class of the `rna` object?

:::::::::::::::::::::::: solution 

You can use the [class](https://rdrr.io/r/base/class.html) or 
[str](https://rdrr.io/r/utils/str.html) functions to look at the class of the
`rna` object.
...
## Challenge 2: What are the names of the objects in `rna`?

:::::::::::::::::::::::: solution 

Since `rna` is a list, we can use the [names](https://rdrr.io/r/base/names.html)
function to get the names of the objects.
...
The `rna` object contains several objects. We describe them briefly in the 
table below.


Name          | Description | Dimensions
--------------+-------------+-------------------------------------------
annots        | Transcript annotation | `r nrow(annot)` X `r ncol(annot)`
covar         | Sample covariates     |  `r nrow(annot)` X `r ncol(covar)`
covar.factors |
datatype      |
display.name  |
expr          |
