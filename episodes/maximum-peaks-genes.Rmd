...
# DMG: Temporary file while waiting for results.
peaks      <- readRDS(file = "data/peaks_all.rds")
...
Note that only `r nrow(peaks_filt)` genes out of r col(expr_rz) have QTL peaks.
