...
hist(ins_tauc[,1], main = "Insulin Area Under the Curve")
```
...
saveRDS(operm, file="data/ins_tauc_perm_1000.rds")
```
...
Campare the results of `find_peaks` function for the untransformed and 
...
We can see a very strong peak on chromosome 11 with no other distiguishable 
