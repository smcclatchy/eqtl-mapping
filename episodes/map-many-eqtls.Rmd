...
```{r set_plot_rows_columns, echo=FALSE, eval=F}
par(mfrow=c(17, 3))
...
```{r short_qtl_peaks_table, echo=FALSE, eval=F}
kable(peaks[1:10,] %>% 
        dplyr::select(-lodindex) %>% 
